<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <li class="nav-item {{ Request::is('flowers', 'flowers/*') ? 'active' : '' }}">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseFlower" aria-expanded="true" aria-controls="collapseFlower">
            <i class="fas fa-fw fa-solid fa-sun"></i>
            <span>Products</span>
        </a>
        <div id="collapseFlower" class="collapse {{ Request::is('flowers', 'flowers/*') ? 'show' : '' }}" aria-labelledby="headingFlower" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item" href="{{ route('flowers.categories.index') }}">Categories</a>
                <a class="collapse-item" href="{{ route('flowers.index') }}">Flowers</a>
            </div>
        </div>
    </li>
    ...
    <li class="nav-item {{ Request::is('transactions', 'transactions/*') ? 'active' : '' }}">
        ...
        <div id="collapseTransaction" class="collapse {{ Request::is('transactions', 'transactions/*') ? 'show' : '' }}" aria-labelledby="headingTransaction" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="{{ route('transactions.index') }}">Records</a>
            </div>
        </div>
    </li>
